        ...
        <div class="modal-body">
            <div class="container-fluid">
                ...
                <div class="form-group">
                    ...
                    <input readonly type="text" class="form-control" id="email" placeholder="">
                    <small class="form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label for="jurusan">Subjek</label>
                    <input readonly type="text" class="form-control" id="subjek" placeholder="">
                    <small class="form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label for="jurusan">Pesan</label>
                    <textarea type="text" class="form-control" id="pesan" placeholder="" rows="5" style="resize: none" readonly> </textarea>
                    <small class="form-text text-danger"></small>
                </div>
                <hr>
            </div>
