  ...
  <div class="container-fluid navbar-inner">
    ...
    <div class="collapse navbar-collapse col-md-2" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        @auth 
        <li class="nav-item dropdown">
          <a href="#"  class="nav-link me-1 mt-1" id="notification-drop" data-bs-toggle="dropdown" >
            ...
            {{-- <span class="bg-danger dots p-1"></span> --}}
            @if (auth()->user()->countUnreadedNotification() > 0)
            <span class="position-absolute translate-middle p-1 bg-danger border border-light rounded-circle" id="notification-dot">
            ...
            <div class="card shadow-none m-0">
              <div class="card-header d-flex justify-content-between bg-primary py-3">
                <div class="header-title d-flex">
                  ...
                  @if (auth()->user()->countUnreadedNotification() != 0)
                  <button class="btn text-white badge" id="mark_read">Mark As Read</button>
                  @endif
                </div>
              </div>
              <div class="card-body p-0">
                ...
                @foreach (auth()->user()->notifikasi()->orderBy('created_at','desc')->take(4)->get() as $message)
                  ...
                  <div class="text-center">
                    <a href="{{route('notifikasi')}}" class="text-secondary">Lihat Semua</a>
                  </div>
                </div>
              </div>
            </div>
