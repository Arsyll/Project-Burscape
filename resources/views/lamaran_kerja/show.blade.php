<head>
    <title>Detail Lamaran | {{ $lamaran->alumni->nama }}</title>
</head>
            ...
            <div class="card mt-5">
                <div class="card-body ms-3">
                    ...
                    <div class="d-flex justify-content-between">
                        <h3 class="me-2 ">{{ $lamaran->alumni->nama }}</h3>
                        <div class="d-flex">
                            <form method="POST" action="{{route('download.resume',$lamaran->alumni->id)}}">
                                @csrf
                                @if (!empty($lamaran->alumni->resume))
                    ...
                    <div class="mt-4 mb-5">
                        <div class="col-md-7 ">
                            {!! $lamaran->alumni->tentang !!}
                        </div>
                        <span class="text-capitalize fs-6 text-secondary ">Alamat : {{$lamaran->alumni->alamat}}</span>
                    </div>
