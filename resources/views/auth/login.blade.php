    ...
    <section class="login-content">
        <div class="row m-0 align-items-center bg-white vh-100">
                        ...
                        <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                            <div class="card-body">
                                <a href="{{ route('dashboard') }}" class="navbar-brand d-flex align-items-center mb-3">
                                    <img width="50"
                                        src="{{ asset('images/icons/Burscapelogo(no-caption).png') }}"></img>
            ...
            <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
                <img src="https://scontent-cgk1-1.xx.fbcdn.net/v/t31.18172-8/12489421_10205438493029743_396920019318511948_o.jpg?stp=dst-jpg_p960x960&_nc_cat=105&ccb=1-7&_nc_sid=8631f5&_nc_ohc=qoQ85FWczIIAX81oJhn&_nc_ht=scontent-cgk1-1.xx&oh=00_AT8A4EOLR9ITalUHjOCWMj87ZWbBlZVduP8Lx4Dz3nyL4w&oe=63633AE6"
