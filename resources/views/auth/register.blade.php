                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id="name"  name="first_name" value="{{old('first_name')}}" class="form-control" type="text" placeholder=" "  autofocus >
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" value="{{old('phone_number')}}" name="phone_number" placeholder=" ">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
